...
export function ThemeToggle({ effective, className = "" }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={cn("relative flex h-11 w-11 items-center justify-center rounded-md text-ink-subtle transition-colors hover:bg-surface-muted hover:text-ink", className)}
